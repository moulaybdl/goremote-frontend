...
export default function InfoCard({
  ...
  return (
    <div className="w-[281px] flex flex-col justify-start gap-2 bg-surface-light border-2 border-dark p-4 rounded-[14px]">
      ...
      {/* availibility */}
      <div className="">
        <span className="font-lexend-medium">Available</span>
      </div>
      {/* post description */}
